...
<head>
    <title>Gym Diary | 完璧なトレーニング記録アプリ</title>
                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <p
                                            ...
                                            Enter the code below in the app to activate your account!</p>
                                                                ...
                                                                <table border="0" cellpadding="0" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        <td
                                                                            style="box-sizing: border-box;font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative;">
                                                                            <b
                                                                                style="font-size: 2rem;">{{ $code }}</b><br />
                                                                            <small>Expiration time is
                                                                                {{ $code_expire_time }}minutes.</small>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                ...
                                <tr>
                                    <td class="content-cell" align="center"
                                        ...
                                        <p
                                            ...
                                            © 2025 Gym Diary | 完璧なトレーニング記録アプリ. All rights reserved.</p>
